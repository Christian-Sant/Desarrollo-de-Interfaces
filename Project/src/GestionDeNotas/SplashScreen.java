...
public class SplashScreen extends JDialog {
    ...
    public SplashScreen() {
        ...
        JLabel lblLogo = new JLabel("CARGANDO...", SwingConstants.CENTER);
        lblLogo.setIcon(null);
        lblLogo.setFont(new Font("Arial", Font.BOLD, 24));
        lblLogo.setForeground(new Color(0, 102, 204));
        
        JLabel mensaje = new JLabel("Cargando recursos para la aplicación de notas, por favor espere...", JLabel.CENTER);
