...
public class pr2 extends JFrame {
	...
	public pr2() {
		...
		ventana = new BufferedImage(450,300,BufferedImage.TYPE_INT_RGB);
	...
	private void dibujar(int x, int y) {
		...
		int size = 100;
		  int[] xPoint = {x, x + size /2, x + size};      // base: puntos a la izquierda y derecha
		  int[] yPoint = {y + size, y, y + size};      // vértice arriba en medio y base abajo
		grafico.drawPolygon(xPoint, yPoint, 3);
		contentPane.repaint();
	}
